...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-F16PNX9NXE"></script>
    <script>
            ...
            <div class="max-w-6xl mx-auto px-5 py-10 lg:py-20">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div class="hidden lg:block lg:col-span-1">
                        ...
                        <p class="text-tryit-cream text-base mb-5">
                    ...
                    <div class="text-center md:text-left">
                        <h4 class="font-display font-bold text-tryit-cream uppercase mb-2.5">
                            Часи роботи
                        </h4>
                            ...
                            <li>
                                <div class="flex items-start gap-2.5">
                                    <div class="text-base md:text-lg">
                                        <span class="text-tryit-cream font-semibold">Пн–Пт:</span>
                                        <span class="text-tryit-cream">08:00 – 20:00</span><br>
                                        <span class="text-tryit-cream font-semibold">Сб:</span>
                                        <span class="text-tryit-cream">09:00 – 18:00</span><br>
                                        <span class="text-tryit-cream font-semibold">Нд:</span>
                                        <span class="text-tryit-cream">Вихідний</span>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul class="flex flex-col items-center lg:items-start space-y-2.5">
                            <li>
                                <a href="tel:+380978778667" class="flex items-center gap-2.5 group"
                                    ...
                                    <span
                                        class="text-tryit-cream text-2xl font-display font-semibold group-hover:text-white transition-colors">+380
                                        (97) 877-866-7</span>
                                </a>
                            </li>
                            <li>
                                <a href="mailto:info@tryit.com.ua" class="flex items-center gap-2.5 group"
                                    ...
                                    <span
                                        class="text-tryit-cream text-xl font-display font-semibold group-hover:text-white transition-colors">
                                        info@tryit.com.ua
                                    </span>
                                </a>
                            </li>
                            <li>
                                <div class="flex items-center gap-2.5">
                                    <span class="text-tryit-cream text-base font-bold">
                                        м. Київ, Україна
                                    </span>
                                </div>
                            </li>
                        ...
                        <div class="flex items-center justify-center md:justify-start gap-2.5 mt-10 lg:mt-5">
                            <a href="https://www.instagram.com/try.it_cleaning?igsh=NGJxNDY4cnFwZ29k&utm_source=qr"
                                ...
                                <img src="{{ Vite::asset('resources/images/icons/footer-instagram.svg') }}"
                                    class="size-6" width="16" height="16" loading="lazy" alt="Instagram" />
                            </a>
                            <a href="#" aria-label="Telegram"
                                class="size-15 md:size-14 rounded-full bg-tryit-orange/20 hover:bg-tryit-orange/30 flex items-center justify-center transition-colors duration-300">
                                <img src="{{ Vite::asset('resources/images/icons/footer-telegram.svg') }}"
                                    class="size-6" width="16" height="16" loading="lazy" alt="Telegram" />
                            </a>
                            <a href="viber://chat?number=380978778667" aria-label="Viber"
                                class="size-15 md:size-14 rounded-full bg-tryit-orange/20 hover:bg-tryit-orange/30 flex items-center justify-center transition-colors duration-300">
                                <img src="{{ Vite::asset('resources/images/icons/footer-viber.svg') }}"
                                    class="size-6" width="16" height="16" loading="lazy" alt="Viber" />
                            </a>
                        </div>
                    </div>
                </div>
