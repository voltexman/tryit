...
<x-layouts::app>
    <x-slot:header>
        <x-page-header image="{{ Vite::asset('resources/images/service-6.jpg') }}">
            <x-slot:title class="text-balance">Комплексне та підтримуюче прибирання офісу</x-slot>
            <x-slot:description class="text-balance">Чистота, комфорт і продуктивність вашого робочого простору</x-slot>
        </x-page-header>
    </x-slot:header>
    ...
    <section class="py-12 md:py-16">
        <div class="max-w-5xl mx-auto px-5">
            <div class="grid lg:grid-cols-2 gap-10 items-start">
                <div>
                    <h2 class="font-display text-2xl md:text-3xl font-bold text-gray-900 mt-2 mb-5">Чистий офіс —
                        продуктивна
                        робота</h2>
