...
<x-layouts::app>
    <x-slot:header>
        <x-page-header image="{{ Vite::asset('resources/images/service-3.jpg') }}">
            <x-slot:title class="text-balance">Післябудівельне прибирання</x-slot>
            <x-slot:description class="text-balance">Комплексне очищення приміщень після ремонту та будівництва</x-slot>
        </x-page-header>
    </x-slot:header>
        ...
        <div class="max-w-5xl mx-auto px-5">
            <div class="grid lg:grid-cols-2 gap-10 items-start">
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed">Будівництво чи ремонт — це завжди оновлення простору, але
                        після
    ...
    <section class="py-20 bg-slate-100 border border-slate-100" x-data="{
        ...
        <div class="max-w-5xl mx-auto px-5 mt-5">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 mt-3">Оберіть зону, щоб побачити результат до та після післябудівельного
                    прибирання
                </p>
            </div>
