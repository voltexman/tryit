...
<x-layouts::app>
    <x-slot:header>
        <x-page-header image="{{ Vite::asset('resources/images/service-5.jpg') }}">
            <x-slot:title class="text-balance">Хімчистка меблів, килимів та авто</x-slot>
            <x-slot:description class="text-balance">Глибоке очищення тканин з відновленням свіжості та кольору</x-slot>
        </x-page-header>
    </x-slot:header>
