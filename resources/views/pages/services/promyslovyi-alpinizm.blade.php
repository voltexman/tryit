...
<x-layouts::app>
    <x-slot:header>
        <x-page-header image="{{ Vite::asset('resources/images/service-7.jpg') }}">
            <x-slot:title class="text-balance">Промисловий альпінізм</x-slot>
            <x-slot:description class="text-balance">Висотні роботи будь-якої складності з гарантією безпеки</x-slot>
        </x-page-header>
    </x-slot:header>
