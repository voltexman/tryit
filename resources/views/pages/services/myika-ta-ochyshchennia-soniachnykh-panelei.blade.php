...
<x-layouts::app>
    <x-slot:header>
        <x-page-header image="{{ Vite::asset('resources/images/service-2.jpg') }}">
            <x-slot:title class="text-balance">Мийка та очищення сонячних панелей</x-slot>
            <x-slot:description class="text-balance">Безпечне очищення для максимальної продуктивності вашої електростанції</x-slot>
        </x-page-header>
    </x-slot:header>
