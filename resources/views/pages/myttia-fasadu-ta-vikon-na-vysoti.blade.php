...
@section('content')
    <x-section>
        ...
        <x-list>
            ...
            <x-list.item>
                Оцінка об’єкта – наші фахівці виїжджають на місце для визначення рівня забруднення, типу поверхні та підбору
                оптимальної технології очищення.
            </x-list.item>
            <x-list.item>
                Підготовка обладнання – використовуємо карбонові штанги з подачею демінералізованої води для ефективного
                очищення.
            </x-list.item>
            <x-list.item>
