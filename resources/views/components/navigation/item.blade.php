...
<a href="{{ $link }}" @click="typeof open !== 'undefined' ? open = false : null" wire:navigate
    {{ $attributes->class([
        ...
        'flex flex-col lg:flex-row items-center justify-center drop-shadow-xl lg:justify-start py-6 lg:py-2.5 px-6 lg:px-4 rounded-xl lg:rounded-full aspect-square lg:aspect-auto transition-all duration-300 gap-3 group w-full lg:w-auto',
