...
<div x-data x-init="window.animateBlog($el)" class="grid lg:grid-cols-3 gap-8">
    {{-- Column 1: Title + First Post --}}
    <div class="space-y-10 blog-animate-item">
        <div class="space-y-5">
    ...
    <div class="lg:pt-35 blog-animate-item">
        @if ($post = $posts->get(1))
            @include('partials.latest-post-item')
        @endif
    </div>
